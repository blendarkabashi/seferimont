          ...
          <div class="grid space-y-3">
            <dl class="grid sm:flex gap-x-3 text-sm">
              ...
              <dd class="text-gray-800 ">
                <span class="block font-semibold">Bashkim Krasniqi</span>
              </dd>
            </dl>
            ...
            <dl class="grid sm:flex gap-x-3 text-sm">
              ...
              <dd class="text-gray-800 ">
                <span class="block font-semibold">+383-49-488-752</span>
              </dd>
            </dl>
            <dl class="grid sm:flex gap-x-3 text-sm">
              <dt class="min-w-[150px] max-w-[200px] text-gray-500">Targat:</dt>
              <dd class="text-gray-800 ">
                <span class="block font-semibold">03-773-DI</span>
              </dd>
            </dl>
          </div>
        </div>
        ...
        <div>
          <div class="grid space-y-3">
            ...
            <dl class="grid sm:flex gap-x-3 text-sm">
              ...
              <dd class="font-medium text-gray-800 ">10 Jan 2023</dd>
            </dl>
          </div>
        </div>
      </div>
